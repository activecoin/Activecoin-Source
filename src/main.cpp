...
uint256 hashGenesisBlock("0x5ac03acf196de4db6b03cca53ac971f8af84ca9ff65823bf0b57bc6d6531c74b");
...
const string strMessageMagic = "ActiveCoin Signed Message:\n";
...
static const int64 nMinSubsidy = 156.25 * COIN;
static const int CUTOFF_HEIGHT = 2073600;
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 345,600 blocks which will occur approximately every 240 days
    nSubsidy >>= (nHeight / 345600); // ActiveCoin: 345,600 blocks


    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 60 * 10; // every 10 blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal ActiveCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ActiveCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x5ac03acf196de4db6b03cca53ac971f8af84ca9ff65823bf0b57bc6d6531c74b");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "ActiveCoin is finally released";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1399732405; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 417541;

        if (fTestNet)
        {
            block.nTime    = 1399732405;
            block.nNonce   = 417541;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xddf98acc432e4a380a6220229ea93ef3b27f7477b8a2c133a7bdcce2c068935e"));
